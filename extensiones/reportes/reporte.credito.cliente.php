...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->setXY(60, 15);
        $this->Cell(100, 8, utf8_decode('Reporte de ventas de rango de fechas'), 0, 1, 'C', 0);
...
$id_cliente_reporte = $_GET["id_cliente_reporte"];

// Obtener datos de ventas
$ventas = ControladorVenta::ctrMostrarReporteVentasCreditoCliente($fecha_desde, $fecha_hasta, $id_usuario, $tipo_pago, $descuento_producto, $id_cliente_reporte);
