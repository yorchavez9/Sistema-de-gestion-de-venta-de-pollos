...
foreach ($proveedores as $proveedor) {
    ...
    $pdf->Cell($anchoNombre, 8, utf8_decode($proveedor['razon_social']), 'B', 0, 'C', 1);
    $pdf->Cell($anchoDocumento, 8, utf8_decode($proveedor['numero_documento']), 'B', 0, 'C', 1);
    $pdf->Cell($anchoDireccion, 8, utf8_decode($proveedor['direccion']), 'B', 0, 'C', 1);
    $pdf->Cell($anchoTelefono, 8, utf8_decode($proveedor['telefono']), 'B', 0, 'C', 1);
    $pdf->Cell($anchoCorreo, 8, utf8_decode($proveedor['email']), 'B', 1, 'C', 1);
